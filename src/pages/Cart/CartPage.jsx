      ...
      <div>
        <div className="flex justify-center items-center flex-col bg-[#0d0d0d]  text-white m-2 rounded-xl p-4 ">
          ...
          <div className="flex justify-center flex-col">
            <button className="bg-yellow-500  rounded-md text-2xl font-bold p-1 mt-2 cursor-pointer transition duration-500 hover:bg-yellow-300 hover:text-[#0d0d0d]">
              Finalizar
            </button>
            <Link to={"/"}>
            <button className="mt-2 cursor-pointer text-x1 text-yellow-400 font-bold hover:text-yellow-300">
